...
Route::controller(EmployeeController::class)->group(function(){
    ...
    Route::get('/dashboard/salary-view','salary_view_page')->name('employee.salary.view')->middleware(['checkroute']);
    Route::post('/dashboard/salary-view','salary_grid')->name('employee.salary.view')->middleware(['checkroute']);
    Route::get('/dashboard/salary-view/{id?}','salary_single_view_page')->name('employee.salary.view')->middleware(['checkroute']);

    Route::get('/dashboard/salary-edit','salary_edit_page')->name('employee.salary.edit')->middleware(['checkroute']);
    Route::post('/dashboard/salary-edit','salary_grid')->name('employee.salary.edit')->middleware(['checkroute']);
...
Route::controller(NoticeController::class)->group(function(){
    ...
    Route::get('/dashboard/notice-edit','notice_edit_page')->name('notice_manage.manage.edit')->middleware(['checkroute']);
    Route::post('/dashboard/notice-edit','notice_grid')->name('notice_manage.manage.edit')->middleware(['checkroute']);
    Route::get('/dashboard/notice-edit/{id?}','notice_single_edit_page')->name('notice_manage.manage.edit')->middleware(['checkroute']);
    Route::post('/dashboard/notice-edit/{id?}','notice_update')->name('notice_manage.manage.edit')->middleware(['checkroute']);
...
Route::controller(SmsAlertController::class)->group(function(){
    ...
    Route::get('/dashboard/sms-alert-view','alert_view_page')->name('sms_email_alert.manage.view')->middleware(['checkroute']);
    Route::post('/dashboard/sms-alert-view','alert_grid')->name('sms_email_alert.manage.view')->middleware(['checkroute']);
    Route::get('/dashboard/sms-alert-view/{id?}','alert_single_view_page')->name('sms_email_alert.manage.view')->middleware(['checkroute']);

    Route::get('/dashboard/sms-alert-resend','alert_re_send_page')->name('sms_email_alert.manage.re_send')->middleware(['checkroute']);
