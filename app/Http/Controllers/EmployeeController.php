...
class EmployeeController extends Controller
{
    ...
    public function employee_store(Request $request){
        ...
        $data->user_type = $user_config_data['employee_user_type'];
        ...
        if ($request->hasFile('user_photo')) {
            ...
            $fileName = $title_name.'_employee_'.time().'.'.$extension;
        ...
        if($data==true){
            ...
            if($status==true){
                ...
                $notification = array(
                    'message'=> "Employee Details Does Not Created Successfully",
                    'alert_type'=>'warning',
                    'create_status'=>0,
                    'user_id' =>'',
                );
    ...
    public function employee_edit_page(){
    ...
    public function employee_update($update_id, Request $request){
        ...
        if($data==true){
            ...
            $notification = array(
                'message'=> "Employee Details Does Not Updated Successfully",
                'alert_type'=>'warning',
                'csrf_token' => csrf_token()
            );
        }
    ...
    public function employee_delete_page(){
    ...
    public function employee_delete($encrypt_id){
        ...
        if(empty($data)){
            ...
            if($data==true){
                ...
                $notification = array(
                    'message'=> "Employee Details Not Deleted Successfully",
                    'alert_type'=>'warning',
                    'csrf_token' => csrf_token()
                );
            }
    ...
    public function employee_right_store ($id, Request $request){
        ...
        if(!empty($right_arr)){
            ...
            if($status==true){
                ...
                $notification = array(
                    'message'=> "Employee Right Not Created Successfully",
                    'alert_type'=>'warning',
                    'csrf_token' => csrf_token()
                );
            }
