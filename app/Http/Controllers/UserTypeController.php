...
class UserTypeController extends Controller
{
    ...
    public function user_type_store (Request $request){
        ...
        if($data==true){
            ...
            $status = $this->common->add_user_activity_history('user_types',$data->id,'Add User Type Details');
    ...
    public function user_type_single_edit_page($encrypt_id){
        ...
        if(empty($user_type_data)){
            ...
            if($header_status==1){
                ...
                return view('admin.reference.user_type.user_type_edit_view',compact('menu_data','user_type_data','user_right_data','encrypt_id'));
            }
            else{

                $system_data = $this->common->get_system_data();

                return view('admin.reference.user_type.user_type_edit_view_master',compact('menu_data','user_type_data','user_right_data','encrypt_id','system_data'));
            }
        }
    }
    ...
    public function user_type_update($id, Request $request){
        ...
        if($data==true){
            ...
            $status = $this->common->add_user_activity_history('user_types',$data->id,'Edit User Type Details');
    ...
    public function user_type_single_view_page($encrypt_id){
        ...
        if(empty($user_type_data)){
            ...
            if($header_status==1){
                ...
                return view('admin.reference.user_type.user_type_single_view',compact('menu_data','user_type_data','user_right_data','encrypt_id'));
            }
            else{

                $system_data = $this->common->get_system_data();

                return view('admin.reference.user_type.user_type_single_view_master',compact('menu_data','user_type_data','user_right_data','encrypt_id','system_data'));
            }
        }
    }
    ...
    public function user_type_delete($encrypt_id){
        ...
        if(empty($data)){
            ...
            if($data==true){
                ...
                $status = $this->common->add_user_activity_history('user_types',$data->id,'Delete User Type Details');
