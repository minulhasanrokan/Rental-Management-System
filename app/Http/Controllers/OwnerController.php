...
class OwnerController extends Controller
{
    ...
    public function owner_single_edit_page($encrypt_id){
        ...
        if(empty($user_data)){
            ...
            if($header_status==1){
                ...
                return view('admin.owner.owner_edit_view',compact('menu_data','user_data','user_right_data','encrypt_id'));
            }
            else{

                $system_data = $this->common->get_system_data();

                return view('admin.owner.owner_edit_view_master',compact('menu_data','user_data','user_right_data','encrypt_id','system_data'));
            }
        }
    }
    ...
    public function owner_delete($encrypt_id){
    ...
    public function owner_single_view_page($encrypt_id){
        ...
        if(empty($user_data)){
            ...
            if($header_status==1){
                ...
                return view('admin.owner.owner_single_view',compact('menu_data','user_data','user_right_data','encrypt_id'));
            }
            else{

                $system_data = $this->common->get_system_data();

                return view('admin.owner.owner_single_view_master',compact('menu_data','user_data','user_right_data','encrypt_id','system_data'));
            }
        }
    }
    ...
    public function owner_right_setup_page($encrypt_id){
        ...
        if(empty($user_data)){
            ...
            if($header_status==1){
                ...
                return view('admin.owner.owner_right_setup',compact('menu_data','user_data','user_right_data','all_right_data','right_data','encrypt_id'));
            }
            else{

                $system_data = $this->common->get_system_data();

                return view('admin.owner.owner_right_setup_master',compact('menu_data','user_data','user_right_data','all_right_data','right_data','encrypt_id','system_data'));
            }
        }
