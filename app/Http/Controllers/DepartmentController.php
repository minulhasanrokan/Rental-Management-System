...
class DepartmentController extends Controller
{
    ...
    public function department_single_edit_page($id){
        ...
        if(empty($department_data)){
            ...
            if($header_status==1){
                ...
                return view('admin.reference.department.department_edit_view',compact('menu_data','department_data','user_right_data'));
            }
            else{

                $system_data = $this->common->get_system_data();

                return view('admin.reference.department.department_edit_view_master',compact('menu_data','department_data','user_right_data','system_data'));
            }
        }
    }
    ...
    public function department_single_view_page($id){
        ...
        if(empty($department_data)){
            ...
            if($header_status==1){
                ...
                return view('admin.reference.department.department_single_view',compact('menu_data','department_data','user_right_data'));
            }
            else{

                $system_data = $this->common->get_system_data();

                return view('admin.reference.department.department_single_view_master',compact('menu_data','department_data','user_right_data','system_data'));
            }
        }
    }
