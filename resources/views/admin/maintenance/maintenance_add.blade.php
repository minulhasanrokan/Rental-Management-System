    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary" style="padding-bottom:0px !important; margin: 0px !important;">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="maintenance_cost_form" method="post" autocomplete="off">
                    @csrf
                    <div class="card-body" style="padding-bottom:5px !important; padding-top: 10px !important; margin: 0px !important;">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="maintenance_cost">Rent <span style="color:red;">*</span></label>
                                    <input type="text" class="form-control text_boxes_numeric" id="maintenance_cost" name="maintenance_cost" placeholder="Enter Rent" required>
                                    <div class="input-error" style="display:none; color: red;" id="maintenance_cost_error" style="display: inline-block; width:100%; color: red;"></div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                    ...
                    <div class="card-footer">
                        <button type="button" style="float:right" onclick="save_maintenance_cost_data();" class="btn btn-primary">Add Maintenance Cost</button>
                    </div>
                </form>
            </div>
            <!-- /.card -->
...
<script>
    ...
    function save_maintenance_cost_data(){

        if( form_validation('building_id*level_id*unit_id*maintenance_cost*water_bill*electricity_bill*gas_bill*security_bill*maintenance_bill*service_bill*charity_bill*other_bill','Building Name*Level Name*Unit Name*Unit Rent*Water Bill*Electricity Bill*Gas Bill*Security Bill*Maintenance Bill*Service Charge*Charity Found*Other Bill')==false ){
        ...
        form_data.append("maintenance_cost", maintenance_cost);
        ...
        http.send(form_data);
        http.onreadystatechange = save_maintenance_cost_data_response;
    }

    function save_maintenance_cost_data_response(){
            ...
            if(http.responseText=='Session Expire' || http.responseText=='Right Not Found'){
                ...
                if (data.errors && data.success==false) {
                    ...
                    if(data.alert_type=='success'){
                        ...
                        document.getElementById("maintenance_cost_form").reset();
                    }
                }
    ...
    function get_unit_load_drop_down_by_id(value)
    {
        ...
        load_drop_down_by_id('units','id,unit_name','unit_id','unit_id_container','Select Unit',0,1,'',0,value,'level_id',"onchange=\"check_duplicate_value_with_two_filed('unit_id','building_id,level_id','maintenance_costrmation',this.value,0,'','');\"",'','');
    }
