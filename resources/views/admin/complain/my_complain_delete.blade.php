...
<script>
    $(document).ready(function () {
        ...
        $('#level_data_table').DataTable({
            ...
            "processing": true,
            "ajax":{
                "url": "{{route('complain_management.my_complain.delete')}}",
                "dataType": "json",
                "type": "POST",
                "data":{ _token: token},
            ...
            "columns": [
                ...
                { data: "user_name" },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        ...
                        var process_status = full.process_status;
                ...
                },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        ...
                        var complain_title = full.complain_title;

                        var menu_data = '';

                        menu.forEach(function(item) {
                            
                            menu_data +='<button onclick="get_new_page(\''+item.r_route_name+'\',\''+item.r_title+'\',\''+data+'\',\''+complain_title+'\');" class="btn btn-primary" style="margin-right:5px;"><i class="fa '+item.r_icon+'"></i></button>'
                        });
