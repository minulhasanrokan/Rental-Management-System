...
@section('content')
                    ...
                    <form id="complain_form" method="post" autocomplete="off">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="complain_title" name="complain_title" placeholder="Enter Complain Title" readonly value="{{$complain_data->complain_title}}" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="complain_details">Complain Rating <span style="color:red;">*</span></label>
                                        <div class="slider-blue">
                                            <input type="text" id="remarks_star" name="remarks_star" value="" class="slider form-control" data-slider-min="0" data-slider-max="100" data-slider-step="5" data-slider-value="[0,{{$complain_data->remarks_star!=''?$complain_data->remarks_star:'0'}}]" data-slider-orientation="horizontal" data-slider-selection="before" data-slider-tooltip="show">
                                        </div>
                                        <div class="input-error" style="display:none; color: red;" id="remarks_star_error" style="display: inline-block; width:100%; color: red;"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="tenant_remarks">Complain Remarks<span style="color:red;">*</span></label>
                                        <textarea class="form-control" id="tenant_remarks" name="tenant_remarks">{{$complain_data->tenant_remarks}}</textarea>
                                        <div class="input-error" style="display:none; color: red;" id="tenant_remarks_error" style="display: inline-block; width:100%; color: red;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-footer">
                            @foreach($user_right_data as $data)
                                <button style="float:left; margin-left:5px;" onclick="get_new_page('{{route($data->r_route_name)}}','{{$data->r_title}}','{{$encrypt_id}}','{{$complain_data->complain_title}}');" type="button" class="btn btn-primary"><i class="fa {{$data->r_icon}}"></i>&nbsp;{{$data->r_name}}</button>
                            @endforeach
    ...
    <script>
        ...
        function save_complain_info_data(){
            ...
            if( form_validation('building_id*level_id*unit_id*complain_title*complain_details*remarks_star*tenant_remarks','Building Name*Level Name*Unit Name*Complain Title*Complain Rating*Complain Details*Complain Remarks')==false ){
            ...
            var remarks_star = $("#remarks_star").val();
            var tenant_remarks = $("#tenant_remarks").val();
            ...
            form_data.append("remarks_star", remarks_star);
            form_data.append("tenant_remarks", tenant_remarks);
            ...
            http.open("POST","{{route('complain_management.my_complain.feedback',$complain_data->id)}}",true);
