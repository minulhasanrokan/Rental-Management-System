        ...
        <div class="login-box">
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.reset.password',$notification['user_id'])}}" method="post">
                        @csrf
                        <div class="input-group mb-3">
                            <input type="hidden" name="hidden_token" id="hidden_token" class="form-control" value="{{$notification['user_id']}}" required>
                            <input type="number" name="token" id="token" class="form-control" placeholder="Insert Token" required>
