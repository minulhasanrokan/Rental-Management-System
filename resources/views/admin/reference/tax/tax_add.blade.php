        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary" style="padding-bottom:0px !important; margin: 0px !important;">
                <div class="card-header">
                    <h3 class="card-title">Add Vat Tax Information</h3>
                </div>
                ...
                <form id="vat_tax_form" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" onchange="check_vat_amount()" class="form-control text_boxes_numeric" id="tax_amount" name="tax_amount" placeholder="Enter Vat Tax Amount" required>
                    ...
                    <div class="card-footer">
                        <button type="button" style="float:right" onclick="save_vat_tax_info_data();" class="btn btn-primary">Add User Type Information</button>
                    </div>
                </form>
            </div>
            <!-- /.card -->
...
<script>
    ...
    function save_vat_tax_info_data(){
        ...
        http.open("POST","{{route('reference_data.tax.add')}}",true);
            ...
            if(http.responseText=='Session Expire' || http.responseText=='Right Not Found'){
                ...
                if (data.errors && data.success==false) {
                    ...
                    if(data.alert_type=='success'){
                        ...
                        document.getElementById("vat_tax_form").reset();
                    }
    ...
    load_drop_down('months','id,name','month_id','month_id_container','Select Month',0,1,'',0,'onchange=\"check_duplicate_value_with_two_filed(\'month_id\',\'year_id\',\'vat_taxes\',this.value,0,\'\',\'\');\"');
