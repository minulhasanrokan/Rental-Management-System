	                        ...
	                        <div class="row">
	                            ...
	                            <div class="col-md-4">
	                                <div class="form-group">
	                                    ...
	                                    <input type="text" onkeyup ="check_vat_amount()" class="form-control text_boxes_numeric" id="tax_amount" name="tax_amount" placeholder="Enter Vat Tax Amount" required>
