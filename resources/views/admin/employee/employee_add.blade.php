    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary" style="padding-bottom:0px !important; margin: 0px !important;">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="employee_form" method="post" autocomplete="off">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" placeholder="Enter Employee E-mail" onkeyup="check_duplicate_value('email','users',this.value,0);" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Enter Employee Mobile" onkeyup="check_duplicate_value('mobile','users',this.value,0);" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" placeholder="Enter Employee Date Of Birth" required>
                    ...
                    <div class="card-footer">
                        <button type="button" style="float:right" onclick="save_user_info_data();" class="btn btn-primary">Add User Employee</button>
                    </div>
                </form>
            </div>
            <!-- /.card -->
...
<script>
    ...
    function save_user_info_data(){
        ...
        if( form_validation('name*email*mobile*date_of_birth*sex*blood_group*group*user_type*department*assign_department*designation*address*user_photo','Employee Name*Employee E-mail*Employee Mobile*Employee Date Of Birth*Employee Gender*Employee Blood Group*Employee Group*Employee Type*Employee Department*Employee Assign Department*Employee Designation*Employee Address*Employee Photo')==false ){
