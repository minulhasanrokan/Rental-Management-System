            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary" style="padding-bottom:0px !important; margin: 0px !important;">
                    <div class="card-header">
                        <h3 class="card-title">Set Employee Right - {{$user_data->name}}</h3>
                    </div>
                    ...
                    <form id="user_right_form" method="post" autocomplete="off">
                        ...
                        <div class="card-footer">
                            ...
                            @endforeach
                            <button type="button" style="float:right" onclick="save_user_right();" class="btn btn-primary">Set Employee Right</button>
                        </div>
                    </form>
                </div>
                <!-- /.card -->
