        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary" style="padding-bottom:0px !important; margin: 0px !important;">
                <div class="card-header">
                    <h3 class="card-title">Add Owner Information</h3>
                </div>
                ...
                <form id="owner_form" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" placeholder="Enter Owner E-mail" onkeyup="check_duplicate_value('email','users',this.value,0);" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Enter Owner Mobile" onkeyup="check_duplicate_value('mobile','users',this.value,0);" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" placeholder="Enter Owner Date Of Birth" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="address" name="address" placeholder="Enter Owner Address" required>
                    ...
                    <div class="card-footer">
                        <button type="button" style="float:right" onclick="save_user_info_data();" class="btn btn-primary">Add Owner</button>
                    </div>
                </form>
            </div>
            <!-- /.card -->
...
<script>
    ...
    function save_user_info_data(){
        ...
        if( form_validation('name*email*mobile*date_of_birth*sex*blood_group*group*user_type*department*assign_department*designation*address*user_photo','Owner Name*Owner E-mail*Owner Mobile*Owner Date Of Birth*Owner Gender*Owner Blood Group*Owner Group*Owner Type*Owner Department*Owner Assign Department*Owner Designation*Owner Address*Owner Photo')==false ){
