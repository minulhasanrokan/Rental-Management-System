                ...
                <form id="alert_form" method="post" autocomplete="off">
                    ...
                    <div class="card-body" style="padding-bottom:5px !important; padding-top: 10px !important; margin: 0px !important;">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="alert_title" name="alert_title" placeholder="Enter Message  Title" readonly value="{{$alert_data->alert_title}}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div id="alert_status_container">
                                        <select disabled class="form-control select" style="width: 100%;" name="email_status" id="email_status">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="alert_details" name="alert_details">{{$alert_data->alert_title}}</textarea>
                    ...
                    <div class="card-footer">
                        @foreach($user_right_data as $data)
                            <button style="float:left; margin-left:5px;" onclick="get_new_page('{{route($data->r_route_name)}}','{{$data->r_title}}','{{$alert_data->id}}','{{$alert_data->alert_title}}');" type="button" class="btn btn-primary"><i class="fa {{$data->r_icon}}"></i>&nbsp;{{$data->r_name}}</button>
                        @endforeach
...
<script>
    ...
    function save_complain_info_data(){
        ...
        form_data.append("update_id", '{{$alert_data->id}}');

        form_data.append("_token", token);

        http.open("POST","{{route('sms_email_alert.manage.re_send',$alert_data->id)}}",true);
    ...
    load_drop_down('user_groups','id,group_name','alert_group','alert_group_container','All Group',0,1,'{{$alert_data->alert_group}}',1,'onchange="load_drop_down_by_id(\'users\',\'id,name\',\'user_id\',\'user_id_container\',\'All User\',0,1,\'\',0,this.value,\'group\',\'\',\'\',\'\')"');

    load_drop_down_by_id('users','id,name','user_id','user_id_container','All User',0,1,'{{$alert_data->user_id}}',1,'{{$alert_data->alert_group}}','group','','','');
