                ...
                <form id="update_user_form" method="post" autocomplete="off">
                    ...
                    <div class="card-body" style="padding-bottom:5px !important; padding-top: 10px !important; margin: 0px !important;">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="sex">Tenant Gender <span style="color:red;">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="blood_group">Tenant Blood Group <span style="color:red;">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="group">Tenant Group <span style="color:red;">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="user_type">Tenant Type <span style="color:red;">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="department">Tenant Depertment <span style="color:red;">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="assign_department">Tenant Assign Depertment <span style="color:red;">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="designation">Tenant Designation <span style="color:red;">*</span></label>
                    ...
                    <div class="card-footer">
                        @foreach($user_right_data as $data)
                            <button style="float:left; margin-left:5px;" onclick="get_new_page('{{route($data->r_route_name)}}','{{$data->r_title}}','{{$encrypt_id}}','{{$tenant_data->name}}');" type="button" class="btn btn-primary"><i class="fa {{$data->r_icon}}"></i>&nbsp;{{$data->r_name}}</button>
                        @endforeach
