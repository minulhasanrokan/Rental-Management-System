...
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary" style="padding-bottom:0px !important; margin: 0px !important;">
                    <div class="card-header">
                        <h3 class="card-title">Edit Notice Information ({{$notice_data->notice_title}})</h3>
                    </div>
                    ...
                    <form id="notice_form" method="post" autocomplete="off">
                        ...
                        <div class="card-body" style="padding-bottom:5px !important; padding-top: 10px !important; margin: 0px !important;">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="notice_title" name="notice_title" placeholder="Enter Notice Title" value="{{$notice_data->notice_title}}" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="notice_date" value="{{$notice_data->notice_date}}" name="notice_date" placeholder="Enter Tenant Name" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="notice_details" name="notice_details">{{$notice_data->notice_details}}</textarea>
                        ...
                        <div class="card-footer">
                            @foreach($user_right_data as $data)
                                <button style="float:left; margin-left:5px;" onclick="get_new_page('{{route($data->r_route_name)}}','{{$data->r_title}}','{{$notice_data->id}}','{{$notice_data->notice_title}}');" type="button" class="btn btn-primary"><i class="fa {{$data->r_icon}}"></i>&nbsp;{{$data->r_name}}</button>
                            @endforeach
                            <button type="button" style="float:right" onclick="save_complain_info_data();" class="btn btn-primary">Update Notice</button>
                        </div>
                    </form>
                </div>
                <!-- /.card -->
    ...
    <script>
        ...
        $("#notice_status").val('{{$notice_data->notice_status}}');
        $("#email_status").val('{{$notice_data->email_status}}');
        ...
        load_drop_down('user_groups','id,group_name','notice_group','notice_group_container','All Group',0,1,'{{$notice_data->notice_group}}',0,'onchange="load_drop_down_by_id(\'users\',\'id,name\',\'user_id\',\'user_id_container\',\'All User\',0,1,\'\',0,this.value,\'group\',\'\',\'\',\'\')"');

        load_drop_down_by_id('users','id,name','user_id','user_id_container','All User',0,1,'{{$notice_data->user_id}}',0,'{{$notice_data->notice_group}}','group','','','');
