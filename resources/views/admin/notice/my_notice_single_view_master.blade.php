                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table table-bordered">
                                        <tr>
                                            <td colspan="6" style="text-align:center;">Notice Title: {{$notice_data->notice_title}}</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="text-align:left;">Notice File</td>
                                        ...
                                        <tr>
                                            <td colspan="6" style="text-align:center;">Notice Details</td>
                                        </tr>
                                        <tr>
                                            <td colspan="6" style="text-align:left;">{!!$notice_data->notice_details!!}</td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="col-md-12">
                                    @foreach($user_right_data as $data)
                                        <button style="float:left; margin-left:5px;" onclick="get_new_page('{{route($data->r_route_name)}}','{{$data->r_title}}','{{$notice_data->id}}','{{$notice_data->unit_rent}}');" type="button" class="btn btn-primary"><i class="fa {{$data->r_icon}}"></i>&nbsp;{{$data->r_name}}</button>
                                    @endforeach
                                </div>
                            </div>
                        </div>
