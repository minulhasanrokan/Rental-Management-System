	        ...
	        <div class="col-md-12">
	            ...
	            <div class="card card-primary" style="padding-bottom:0px !important; margin: 0px !important;">
	                <div class="card-header">
	                    <h3 class="card-title">Edit View All Unit Rent Information</h3>
	                </div>
	                        ...
	                        <table id="level_data_table" class="table table-bordered table-striped" style="text-align: center !important; vertical-align: middle !important;" rules="all">
	                            <thead>
	                                <tr>
	                                    ...
	                                    <th width="150">Transfer Owner</th>
	...
	<script>
	    $(document).ready(function () {
	        ...
	        $('#level_data_table').DataTable({
	            ...
	            "processing": true,
	            "ajax":{
	                "url": "{{route('floor_management.tag_unit_owner.transfer_view')}}",
	                "dataType": "json",
	                "type": "POST",
	                "data":{ _token: token},
