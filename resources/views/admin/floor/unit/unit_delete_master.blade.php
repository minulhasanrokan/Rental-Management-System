	        ...
	        <div class="col-md-12">
	            ...
	            <div class="card card-primary" style="padding-bottom:0px !important; margin: 0px !important;">
	                <div class="card-header">
	                    <h3 class="card-title">Delete View All Unit Information</h3>
	                </div>
	...
	<script>
	    $(document).ready(function () {
	        ...
	        $('#level_data_table').DataTable({
	            ...
	            "processing": true,
	            "ajax":{
	                "url": "{{route('floor_management.unit.delete')}}",
	                "dataType": "json",
	                "type": "POST",
	                "data":{ _token: token},
	            ...
	            "columns": [
	                ...
	                },
	                {
	                    ...
	                    "render": function(data, type, full, meta) {
	                        ...
	                        if (type === 'display') {
	                            return '<img src="{{url('uploads/unit')}}/' + data + '" alt="'+titleValue+'" width="35" height="35">';
	                        }
	                        return data;
	                    }
	                },
