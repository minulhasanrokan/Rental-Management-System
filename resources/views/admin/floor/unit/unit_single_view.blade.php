                ...
                <div class="card" style="margin: 0px !important;">
                    <div class="card-body" style="padding-bottom:5px !important; padding-top: 10px !important; margin: 0px !important;">
                        <div class="row">
                            ...
                            <div class="col-md-6"><p>Unit Name: {{$unit_data->unit_name}}</p></div>
                            <div class="col-md-6"><p>Unit Code: {{$unit_data->unit_code}}</p></div>
                            <div class="col-md-6"><p>Unit Title: {{$unit_data->unit_title}}</p></div>
                            <div class="col-md-6"><p>unit Status: {{$unit_data->status==1?'Active':'Inactive'}}</p></div>
