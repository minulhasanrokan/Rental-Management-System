                                ...
                                <div class="card card-primary card-outline">
                                    <div class="card-body box-profile">
                                        <div class="text-center">
                                            <img class="profile-user-img img-fluid img-circle" src="{{asset('uploads/user')}}/{{!empty($user_data->user_photo)?$user_data->user_photo:'user.png'}}" alt="User profile picture">
                                        </div>
