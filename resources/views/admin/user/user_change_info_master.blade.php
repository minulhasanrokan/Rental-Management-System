...
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary" style="padding-bottom:0px !important; margin: 0px !important;">
                    <div class="card-header">
                        <h3 class="card-title">Edit User Information - {{$user_info_data->name}}</h3>
                    </div>
                    ...
                    <form id="update_user_form" method="post" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter User Name" value="{{$user_info_data->name}}" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" readonly id="email" name="email" placeholder="Enter User E-mail" value="{{$user_info_data->email}}" onkeyup="check_duplicate_value('email','users',this.value,'{{$user_info_data->id}}');" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$user_info_data->mobile}}" readonly class="form-control" id="mobile" name="mobile" placeholder="Enter User Mobile" onkeyup="check_duplicate_value('mobile','users',this.value,'{{$user_info_data->id}}');" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" value="{{$user_info_data->date_of_birth}}" class="form-control" id="date_of_birth" name="date_of_birth" placeholder="Enter User Date Of Birth" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$user_info_data->address}}" type="text" class="form-control" id="address" name="address" placeholder="Enter User Address" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="details" name="details">{{$user_info_data->details}}</textarea>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="hidden_user_photo" id="hidden_user_photo" value="{{$user_info_data->user_photo}}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <img class="rounded avatar-lg" width="80" height="80" id="user_photo_photo" src="{{asset('uploads/user')}}/{{!empty($user_info_data->user_photo)?$user_info_data->user_photo:'user.png'}}"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-footer">
                            <button type="button" style="float:right" onclick="update_user_info_data();" class="btn btn-primary">Update Info</button>
                        </div>
                    </form>
                </div>
                <!-- /.card -->
    ...
    <script>
        ...
        function update_user_info_data(){
            ...
            form_data.append("update_id", '{{$user_info_data->id}}');
            form_data.append("_token", token);

            freeze_window(0);

            http.open("POST","{{route('profile.manage.change_info')}}",true);
        ...
        load_drop_down('genders','id,gender_name','sex','sex_container','Select Gender',0,0,'{{$user_info_data->sex}}',0,'');
        load_drop_down('blood_groups','id,blood_group_name','blood_group','blood_group_container','Select Blood Group',0,0,'{{$user_info_data->blood_group}}',0,'');
        load_drop_down('user_groups','id,group_name','group','group_container','Select Group',0,0,'{{$user_info_data->group}}',1,'');
        ...
        load_drop_down('departments','id,department_name','department','department_container','Select Department',0,0,'{{$user_info_data->department}}',1,'');
        load_drop_down('departments','id,department_name','assign_department','assign_department_container','Select Assign Department',1,0,'{{$user_info_data->assign_department}}',1,'');
        load_drop_down('designations','id,designation_name','designation','designation_container','Select Designation',0,0,'{{$user_info_data->designation}}',1,'');
