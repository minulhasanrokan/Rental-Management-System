...
@section('content')
	        ...
	        <div class="col-md-12">
	            ...
	            <div class="card card-primary" style="padding-bottom:0px !important; margin: 0px !important;">
	                <div class="card-header">
	                    <h3 class="card-title">Close Rent Information</h3>
	                </div>
	                ...
	                <form id="unit_rent_form" method="post" autocomplete="off">
	                    ...
	                    <div class="card-footer">
	                        ...
	                        @endforeach
	                        <button type="button" style="float:right" onclick="save_unit_rent_info_data();" class="btn btn-primary">Close Rent Information</button>
	                    </div>
	                </form>
	            </div>
	            <!-- /.card -->
	...
	<script>
	    ...
	    function save_unit_rent_info_data(){
	        ...
	        http.open("POST","{{route('rent_management.rental.close',$rent_data->id)}}",true);
