...
@section('content')
	        ...
	        <div class="col-md-12">
	            ...
	            <div class="card card-primary" style="padding-bottom:0px !important; margin: 0px !important;">
	                <div class="card-header">
	                    <h3 class="card-title">Chnage Rent Information</h3>
	                </div>
	                ...
	                <form id="unit_rent_form" method="post" autocomplete="off">
	                    ...
	                    <div class="card-footer">
	                        @foreach($user_right_data as $data)
	                            <button style="float:left; margin-left:5px;" onclick="get_new_page('{{route($data->r_route_name)}}','{{$data->r_title}}','{{$encrypt_id}}','{{$rent_data->id}}');" type="button" class="btn btn-primary"><i class="fa {{$data->r_icon}}"></i>&nbsp;{{$data->r_name}}</button>
	                        @endforeach
	                        <button type="button" style="float:right" onclick="save_unit_rent_info_data();" class="btn btn-primary">Change Rent Information</button>
	                    </div>
	                </form>
	            </div>
	            <!-- /.card -->
	...
	<script>
	    ...
	    function save_unit_rent_info_data(){
	        ...
	        http.open("POST","{{route('rent_management.rental.change',$rent_data->id)}}",true);
