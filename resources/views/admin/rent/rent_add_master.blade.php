...
@section('content')
	            ...
	            <div class="card card-primary" style="padding-bottom:0px !important; margin: 0px !important;">
	                ...
	                <form id="unit_rent_form" method="post" autocomplete="off">
	                        ...
	                        <div class="row">
	                            ...
	                            <div class="col-md-3">
	                                <div class="form-group">
	                                    ...
	                                    <input type="text" readonly class="form-control text_boxes_numeric" id="unit_rent" name="unit_rent" placeholder="Enter Rent" required>
	                            ...
	                            <div class="col-md-3">
	                                <div class="form-group">
	                                    ...
	                                    <input type="text" class="form-control text_boxes_numeric" id="water_bill" name="water_bill" readonly placeholder="Enter Water Bill" required>
	                            ...
	                            <div class="col-md-3">
	                                <div class="form-group">
	                                    ...
	                                    <input type="text" class="form-control text_boxes_numeric" id="electricity_bill" name="electricity_bill" readonly placeholder="Enter Electricity Bill" required>
	                            ...
	                            <div class="col-md-3">
	                                <div class="form-group">
	                                    ...
	                                    <input type="text" readonly class="form-control text_boxes_numeric" id="gas_bill" name="gas_bill" placeholder="Enter Gas Bill" required>
	                            ...
	                            <div class="col-md-3">
	                                <div class="form-group">
	                                    ...
	                                    <input type="text" readonly class="form-control text_boxes_numeric" id="security_bill" name="security_bill" placeholder="Enter Security Bill" required>
	                            ...
	                            <div class="col-md-3">
	                                <div class="form-group">
	                                    ...
	                                    <input type="text" readonly class="form-control text_boxes_numeric" id="maintenance_bill" name="maintenance_bill" placeholder="Enter Maintenance Bill" required>
	                            ...
	                            <div class="col-md-3">
	                                <div class="form-group">
	                                    ...
	                                    <input type="text" readonly class="form-control text_boxes_numeric" id="service_bill" name="service_bill" placeholder="Enter Service Charge" required>
	                            ...
	                            <div class="col-md-3">
	                                <div class="form-group">
	                                    ...
	                                    <input type="text" readonly class="form-control text_boxes_numeric" id="charity_bill" name="charity_bill" placeholder="Enter Charity Fund" required>
	                            ...
	                            <div class="col-md-3">
	                                <div class="form-group">
	                                    ...
	                                    <input type="text" readonly class="form-control text_boxes_numeric" id="other_bill" name="other_bill" placeholder="Enter Other Bill" required>
	                    ...
	                    <div class="card-footer">
	                        <button type="button" style="float:right" onclick="save_unit_rent_info_data();" class="btn btn-primary">Add Rent Information</button>
	                    </div>
	                </form>
	            </div>
	            <!-- /.card -->
	...
	<script>
	    ...
	    function save_unit_rent_info_data(){
	        ...
	        http.open("POST","{{route('rent_management.rental.add')}}",true);
	    ...
	    function get_unit_load_drop_down_by_id(value){
	        ...
	        load_drop_down_by_id('units','id,unit_name','unit_id','unit_id_container','Select Unit',0,1,'',0,value,'level_id',"onchange=\"check_duplicate_value_with_two_filed('unit_id','building_id,level_id','rents',this.value,0,'close_status','0'); empty_rent_info();\"",'rent_status','0');
	    }
